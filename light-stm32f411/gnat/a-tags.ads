...
--     Check_TSD: These subprograms are used for cross-referencing the external
--     and internal representation of tags. The implementation of these
--     routines was considered neither simple nor essential for this restricted
...
--     support for interface types that are not supported by this runtime
