...
package body System.BB.Interrupts is
   ...
   begin
      ...
      --  Call tracing event hook for start of interrupt

      System.Tracing_Hooks.Call_Interrupt_Hook
        (System.Tracing_Hooks.Interrupt_Start, Integer (Id));
      ...
      --  Call tracing event hook for end of interrupt

      System.Tracing_Hooks.Call_Interrupt_Hook
        (System.Tracing_Hooks.Interrupt_End, Integer (Id));
