...
class Stm32F4(arm.cortexm.CortexM4F):
    ...
    def __init__(self):
        ...
        # so it gets its own "stm32f429" source directory. STM32F446 also
        # has its own "stm32f446" source directory. More variants may be
        ...
        for sub_family in ["F427", "F429", "F446"]:
