...
--  This is a version for the STM32F446 MCU
package Ada.Interrupts.Names is
   ...
   HDMI_CEC_Interrupt            : constant Interrupt_ID := 93;

   --  SPDIF-Rx global interrupt
   SPDIF_Rx_Interrupt            : constant Interrupt_ID := 94;

   --  FMPI2C1 event interrupt
   FMPI2C1_Interrupt             : constant Interrupt_ID := 95;

   --  FMPI2C1 error interrupt
   FMPI2C1_error_Interrupt       : constant Interrupt_ID := 96;
