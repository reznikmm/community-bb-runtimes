...
package Interfaces.STM32.RCC is
   ...
   subtype APB1ENR_RTCAPB_Field is Interfaces.STM32.Bit;
   ...
   type APB1ENR_Register is record
      ...
      --  clock enable
      RTCAPB         : APB1ENR_RTCAPB_Field := 16#0#;
   ...
   subtype APB2ENR_DFSDMEN_Field is Interfaces.STM32.Bit;
   ...
   type APB2ENR_Register is record
      ...
      Reserved_21_23 : Interfaces.STM32.UInt3 := 16#0#;
      --  DFSDMEN
      DFSDMEN        : APB2ENR_DFSDMEN_Field := 16#0#;
      --  unspecified
      Reserved_25_31 : Interfaces.STM32.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type AHB2LPENR_Register is record
      --  unspecified
      Reserved_0_5  : Interfaces.STM32.UInt6 := 16#31#;
      --  RNGLPEN
   ...
   type AHB3LPENR_Register is record
      ...
      QSPILPEN      : AHB3LPENR_QSPILPEN_Field := 16#1#;
      --  unspecified
      Reserved_2_31 : Interfaces.STM32.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype APB1LPENR_RTCAPBLPEN_Field is Interfaces.STM32.Bit;
   ...
   type APB1LPENR_Register is record
      ...
      RTCAPBLPEN     : APB1LPENR_RTCAPBLPEN_Field := 16#0#;
   ...
   subtype APB2LPENR_EXTITEN_Field is Interfaces.STM32.Bit;
   ...
   subtype APB2LPENR_DFSDMLPEN_Field is Interfaces.STM32.Bit;
   ...
   type APB2LPENR_Register is record
      ...
      EXTITEN        : APB2LPENR_EXTITEN_Field := 16#0#;
      ...
      Reserved_21_23 : Interfaces.STM32.UInt3 := 16#0#;
      --  DFSDMLPEN
      DFSDMLPEN      : APB2LPENR_DFSDMLPEN_Field := 16#0#;
      --  unspecified
      Reserved_25_31 : Interfaces.STM32.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype PLLI2SCFGR_PLLI2SSRC_Field is Interfaces.STM32.Bit;
   ...
   type PLLI2SCFGR_Register is record
      ...
      PLLI2SSRC      : PLLI2SCFGR_PLLI2SSRC_Field := 16#0#;
      --  unspecified
      Reserved_23_23 : Interfaces.STM32.Bit := 16#0#;
   ...
   subtype DCKCFGR_CKDFSDM1ASEL_Field is Interfaces.STM32.Bit;
   ...
   subtype DCKCFGR_CKDFSDM1SEL_Field is Interfaces.STM32.Bit;

   --  Dedicated Clocks Configuration Register
   type DCKCFGR_Register is record
      --  unspecified
      Reserved_0_14  : Interfaces.STM32.UInt15 := 16#0#;
      --  DFSDM1 audio clock selection
      CKDFSDM1ASEL   : DCKCFGR_CKDFSDM1ASEL_Field := 16#0#;
      --  unspecified
      ...
      CKDFSDM1SEL    : DCKCFGR_CKDFSDM1SEL_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CKGATENR_EVTCL_CKEN_Field is Interfaces.STM32.Bit;
   ...
   type CKGATENR_Register is record
      ...
      --  EVTCL_CKEN
      EVTCL_CKEN    : CKGATENR_EVTCL_CKEN_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : Interfaces.STM32.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype DCKCFGR2_I2CFMP1SEL_Field is Interfaces.STM32.UInt2;
   subtype DCKCFGR2_CK48MSEL_Field is Interfaces.STM32.Bit;
   subtype DCKCFGR2_CKSDIOSEL_Field is Interfaces.STM32.Bit;
   ...
   type DCKCFGR2_Register is record
      ...
      I2CFMP1SEL     : DCKCFGR2_I2CFMP1SEL_Field := 16#0#;
      --  unspecified
      ...
      CKSDIOSEL      : DCKCFGR2_CKSDIOSEL_Field := 16#0#;
      --  unspecified
      Reserved_29_31 : Interfaces.STM32.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
