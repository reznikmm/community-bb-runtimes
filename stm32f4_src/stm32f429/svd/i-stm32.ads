...
--  This spec has been automatically generated from STM32F429.svd
...
package Interfaces.STM32 is
   ...
   --  Only the peripherals actually used by this runtime (RCC, FLASH, PWR)
   --  are kept here; the STM32F429.svd file defines base addresses for
